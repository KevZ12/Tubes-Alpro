...
func opsiMenu() {
	...
	fmt.Println("                       9. Tampilkan data pasien berdasarkan priode nama                              ")
	...
	fmt.Println("-----------------------------------------------------------------------------------------------------")
	fmt.Println("                             Pilihlah opsi yang valid diantara 1 hingga 12                            ")
	fmt.Println("-----------------------------------------------------------------------------------------------------")
}
...
func test(tMcu *dataMcu, id string, nMcu *int) {
	var idx int
	var berenti bool
	berenti = false
	for i := 0; i < *nMcu && berenti == false; i++ {
